...
@app.route("/")
def arquivo():
    arq = open('D:\AndroidStudioProjects/SmartCampus/SmartCampusServidor/arquivos/teste1.txt', 'r')
    texto = arq.readlines()
    for linha in texto:
        print(linha)
    arq.close()
...
def arCondicionado(ligado, tempo, auto):
        arq = open('D:\AndroidStudioProjects/SmartCampus/SmartCampusServidor/arquivos/tempo.txt', 'w')
...
def projetoPersiana(ligadoProjetor, ligadoPersiana):
        arq = open('D:\AndroidStudioProjects/SmartCampus/SmartCampusServidor/arquivos/arquivos/proPer.txt', 'w')
...
@app.route('/lixeira/')
def lixeira():
        arq = open('D:\AndroidStudioProjects/SmartCampus/SmartCampusServidor/arquivos/capacidadeDaLixeira.txt', 'r')
